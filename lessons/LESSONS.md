...
| [ ] | 06  | 🖥️ Random Numbers in Java              | Generate random values using `Random` and `Math.random()` for games and simulations. | [Open Lesson](./LESSON06.md) | [WORK IN PROGRESS] | Optional | — skip for now |
